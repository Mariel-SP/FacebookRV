...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder>{
    ...
    class  ViewHolder extends RecyclerView.ViewHolder{
        ...
        public  void bindItems(IViewModel publicacion){
            ImageView ic_Perfil = itemView.findViewById(R.id.userimg);
            TextView nombre=itemView.findViewById(R.id.nombre);
            TextView user = itemView.findViewById(R.id.apellido);
            ...
            ic_Perfil.setImageResource(publicacion.getIc_user());
            nombre.setText(publicacion.getNombre());
            user.setText(publicacion.getUser());
            hora.setText("Publicado hace un momento " + String.valueOf(publicacion.getHora()));
